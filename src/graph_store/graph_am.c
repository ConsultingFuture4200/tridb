 ...
 * gm_edge_count is a raw monotone counter and is deliberately NOT decremented (physical reclamation
 * rides plan 036's freeze pass). Owner-guarded (REVOKEd from PUBLIC, plan 026).
 *
