...
if __name__ == "__main__":
    ...
    print("Intermediate rows (filter_first):", estimated_intermediate_rows(stats, "filter_first"))
    print("Intermediate rows (vector_first):", estimated_intermediate_rows(stats, "vector_first"))
